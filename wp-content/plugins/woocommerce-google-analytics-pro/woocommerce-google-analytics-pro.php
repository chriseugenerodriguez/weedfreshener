 ...
 *
 * Copyright: (c) 2015-2017, SkyVerge, Inc.
 *
...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.6.0', 'WooCommerce Google Analytics Pro', __FILE__, 'init_woocommerce_google_analytics_pro', array(
...
class WC_Google_Analytics_Pro extends SV_WC_Plugin {
	...
	public function is_monsterinsights_active() {
		return $this->is_plugin_active( 'googleanalytics.php' );
	}
