...
class SV_WC_Tracking_Integration extends WC_Integration {
	...
	/** @var int an order ID that was fully refunded **/
	 ...
	 *
	 * Should be overridden and called from whithin subclasses, so that they can
	 ...
	 *
	 * In 1.3.0 moved to \SV_WC_Tracking_Integration from \WC_Google_Analytics_Pro
	 *
	 * @since 1.0.3
	...
	/**
	 * Tracks when an order was fully refunded.
	 *
