	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( $data[ 'modifier' ] === 'in' && $contains_qualifying_products ) {
			...
			if ( count( $term_names ) == 1 ) {
				...
				return sprintf( _n( 'remove all products in the &quot;%s&quot; category from your cart', 'remove all products in the &quot;%s&quot; category from this shipment', $package_count, 'woocommerce-conditional-shipping-and-payments' ), current( $term_names ) );
