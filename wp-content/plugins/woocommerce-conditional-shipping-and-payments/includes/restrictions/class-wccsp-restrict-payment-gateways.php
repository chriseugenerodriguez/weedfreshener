...
class WC_CSP_Restrict_Payment_Gateways extends WC_CSP_Restriction implements WC_CSP_Checkout_Restriction {
	...
	function generate_admin_global_fields_html() {
		?><p>
			<?php echo __( 'Restrict the payment gateways available during checkout when the defined conditions apply. Complex rules can be created by adding multiple restriction instances. Each instance will be evaluated independently.', 'woocommerce-conditional-shipping-and-payments' ); ?>
		</p><?php
